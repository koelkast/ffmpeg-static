...
./fetchurl "http://heanet.dl.sourceforge.net/project/libpng/libpng15/1.5.7/libpng-1.5.7.tar.gz"
...
./fetchurl "http://ftp.videolan.org/pub/x264/snapshots/last_x264.tar.bz2"
...
./fetchurl "http://heanet.dl.sourceforge.net/project/faac/faac-src/faac-1.28/faac-1.28.tar.gz"
...
git clone https://github.com/FFmpeg/FFmpeg.git "$BUILD_DIR/ffmpeg-latest"
echo "*** Building FFmpeg ***"
cd "$BUILD_DIR/ffmpeg-latest"
./configure --prefix=${OUTPUT_DIR:-$TARGET_DIR} --extra-version=static --disable-debug --enable-libvpx --enable-libx264 --disable-shared --disable-ffplay --disable-ffserver --disable-doc --enable-gpl --enable-pthreads --enable-postproc --enable-gray --enable-runtime-cpudetect --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libx264 --enable-libxvid --enable-bzlib --enable-zlib --enable-nonfree --enable-version3 --enable-libvpx --disable-devices --enable-decoder=prores --enable-libfaac
make -j 4 && make install